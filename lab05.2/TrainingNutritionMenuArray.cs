...
public class TrainingNutritionMenuArray<T>
{
    public T[] products;
    int count;

    public TrainingNutritionMenuArray() => products = new T[10];

    public TrainingNutritionMenuArray(int length) => products = new T[length];
